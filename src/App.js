      ...
      <div className="App">
        <BrowserRouter>
          <ThemeProvider theme={theme}>
            <CssBaseline />
            <ToastContainer pauseOnHover autoClose={3000} />
            <Routes>
              <Route element={<Layout />}>
                ...
                <Route element={<RequireAuth />}>
                  ...
                  />
                  <Route
                    path="/rentals/:studentId"
                    element={<StudentsRentalsPage />}
                  />
                  ...
                  />
                  <Route
                    path="/teachers/teachers-rentals/:teacherId"
                    element={<TeachersRentalsPage />}
                  />
                  <Route
                    path="/edit/teachers-rental/:rentalId"
                    element={<EditTeacherRentalPage />}
                  />
                  ...
                  <Route
                    path="/add/student-rental/:studentId"
                    element={<AddStudentBookRentalPage />}
                  />
                  <Route
                    path="/add/teacher-rental/:teacherId"
                    element={<AddTeacherBookRentalPage />}
                  />
