...
const DashboardStats = () => {
    ...
    return (
        <Box sx={{display: 'flex', gap: 2, mb: '2rem', mt: '2rem', justifyContent: 'end'}}>
            <Card sx={{
                width: 200,
                height: 150,
                ...
                <Typography variant="h3">
                    {isLoading ? <Bars
                        ...
                        wrapperClass=""
                        visible={true}
                    /> : `${statistics.revenue} Rwf`}</Typography>
            ...
            <Card sx={{
                ...
                <Typography variant="h3">
                    {isLoading ? <Bars
                        ...
                        wrapperClass=""
                        visible={true}
                    /> : statistics.lostBooks}</Typography>
            ...
            <Card sx={{
                ...
                <Typography variant="h3">
                    {isLoading ? <Bars
                        ...
                        wrapperClass=""
                        visible={true}
                    /> : statistics.issuedBooks}</Typography>
