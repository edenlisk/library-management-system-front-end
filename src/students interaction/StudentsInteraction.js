...
import {useGetOneStudentQuery, useGetStudentRentalsQuery} from "../states/apiSlice";
import {
    ...
    return (
        <>
            <UserNavbar studentId={studentId}
                        userName={StName}/>
            <Box display="flex" flexDirection="column" gap="15px" padding="0px 20px 20px 20px"><Typography
                variant="h3">{StName}</Typography>
                <Box display="grid"
                     sx={{
                ...
                >
                    <StudentsStatsCards title="Fine" value={StData.fine} icon={<MonetizationOnTwoTone
                        sx={{fontSize: "30px", color: theme.palette.dashboard.main}}/>}
                                        gridArea="box1"></StudentsStatsCards>
                    <StudentsStatsCards title="Rentals" value={rents.length} icon={<LibraryBooksTwoTone
                        sx={{fontSize: "30px", color: theme.palette.dashboard.main}}/>}
                                        gridArea="box2"></StudentsStatsCards>
                    <StudentsStatsCards title="Un-returned Rentals" value={unReturned} icon={<CancelTwoTone
                        sx={{fontSize: "30px", color: theme.palette.dashboard.main}}/>}
                                        gridArea="box3"></StudentsStatsCards>
                    <StudentsStatsCards title="Overdue Rentals" value={OverdueBooks.length} icon={<AssignmentLateTwoTone
                        sx={{fontSize: "30px", color: theme.palette.dashboard.main}}/>}
                                        gridArea="box4"></StudentsStatsCards>
