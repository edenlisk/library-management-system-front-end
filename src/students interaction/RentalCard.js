...
import { useTheme, Typography, Button, Card, CardContent, CardActions, Collapse, Box, Tooltip, useMediaQuery, Skeleton } from "@mui/material";
import FlexBetween from "../components/FlexBetween";
import { AssignmentIndOutlined, AssignmentTurnedIn, CheckBox, EventAvailableTwoTone } from "@mui/icons-material";
const RentalCard = ({ title, category, daysLeft, issueDate, dueDate, author, rentalId, returned, isLoading }) => {
  ...
  return (
    <>
      ...
      >{isLoading?<Skeleton sx={{width:"100%",height:"100px"}}/>:(<>
        <Box sx={{ p: "0px", pb: "4px" }}>
          <FlexBetween>
